...
#define ADC_GPIO_PIN_RAW1               LL_GPIO_PIN_5      // PC.05 6POS ADC123_INP8
...
#define ADC_GPIOC_PINS                  (ADC_GPIO_PIN_POT1 | ADC_GPIO_PIN_POT2 | ADC_GPIO_PIN_RAW1 | ADC_GPIO_PIN_BATT)
...
#define ADC_CHANNEL_RAW1                LL_ADC_CHANNEL_8
